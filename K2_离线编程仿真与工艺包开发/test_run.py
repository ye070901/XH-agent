...
def export_diagnosis_json(data: dict, filename: str):
    """将 diagnosis_result 以格式化 JSON 输出并保存到文件"""
...
def test_case_1():
    ...
    export_diagnosis_json(state, "case1.json")
...
def test_case_2():
    ...
    export_diagnosis_json(state, "case2.json")
...
def test_case_3():
    ...
    export_diagnosis_json(state, "case3.json")
