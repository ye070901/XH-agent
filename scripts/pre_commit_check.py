...
_MODULES_TO_CHECK: list[tuple[str, str]] = [
    ...
    ("backend.src.knowledge.store", "KnowledgeBase 知识库"),
    ("backend.src.llm", "LLM 客户端包"),
    ("backend.src.scheduler", "Agent 调度器包"),
    ("backend.src.scheduler.pipeline", "PipelineScheduler 流水线调度器"),
    ...
    ("backend.src.event_broadcast.bus", "EventBus 单例 + EventType 枚举"),
